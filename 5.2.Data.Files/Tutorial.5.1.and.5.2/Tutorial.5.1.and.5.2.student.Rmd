...
Create a data frame called "hot_springs" with 3 columns named "sample", "temp", and "pH", containing the information above. Use the appropriate data type for each column.
...
Write a new CSV file to the directory "/home/jovyan/Week.5/5.2.Data.Files/Tutorial.5.1.and.5.2" called "sequencing_reads.csv". The CSV file should contain the data frame `sequencing_reads`.
