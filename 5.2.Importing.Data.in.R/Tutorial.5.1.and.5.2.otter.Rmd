...
Note: the file has a header and is located in the directory: "/home/joyvan/Week.5/5.2.Importing.Data.in.R/Tutorial.5.1.and.5.2/5.2.Data.Files".
```{r}
# Write and execute your code here
# YOUR CODE HERE
```
...
Note: the file has a header and is located in the directory: "/home/joyvan/Week.5/5.2.Data.Files".
```{r}
# Write and execute your code here
# YOUR CODE HERE
```
...
Write a new CSV file to the directory "/home/joyvan/Week.5/5.2.Data.Files/Tutorial" called "sequencing_reads.csv". The CSV file should contain the data frame `sequencing_reads`.
```{r}
# Write and execute your code here
# YOUR CODE HERE
```
