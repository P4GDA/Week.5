...
Read in the CSV "hot_spring_data.csv" and will be in the directory "/home/jovyan/Week.5/5.3.The.dply.Package/Tutorial.5.3". Save the data to a variable called "hot_springs".
```{r}
