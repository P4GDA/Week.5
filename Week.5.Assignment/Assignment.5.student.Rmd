...
This assignment covers the content in week 5 lectures and tutorials. Be sure to run the above code block to load the dplyr package.
...
#### a. 
(1 mark)
Read in the phenotyping data for the Dsg2 gene knockout mice and controls. The data is stored in the CSV: "Dsg2_phenotypic_data.csv" which is located in the directory: "/home/jovyan/Week.5/Week.5.Assignment". Save the data to a variable called "Dsg2_phenotypes".
```{r Assignment.W5.1.a}
...
#### d. 
(2 marks)
Use the `group_by()` and `summarise()` functions to get the number of mutant and control mice with an abnormal and a normal coat appearance. Name the column that contains the number "count". Assign the output data frame to a variable named "coat_appearance_counts". Hint: There should be more than two rows in the output data frame.
```{r Assignment.W5.2.d}
# Write and execute your code here
...
#### a. 
(1 mark)
Read in the phenotyping data for the Hmcn1 gene knockout mice and controls. The data is stored in the CSV: "Hmcn1_phenotypic_data.csv" which is located in the directory: "/home/jovyan/Week.5/Week.5.Assignment". Save the data to a variable called "Hmcn1_phenotypes".
```{r Assignment.W5.3.a}
# Write and execute your code here
...
#### e. 
(2 marks)
For the sexually dimorphic phenotype determined in the previous question, create a data frame called "dimorphic_stats" that includes the following columns:
